  ...
  implements OnGatewayConnection, OnGatewayDisconnect
{
  ...
  /**
   * Notify user that their submission has been analyzed by AI
   *
   * @param userId - ID of the user to notify
   * @param submissionId - ID of the analyzed submission
   * @param analysisReport - Analysis report generated by AI
   * @param attemptId - ID of the submission attempt
   */
  public notifySubmissionAnalyzed(
    ...
    this.logger.debug(
      `Emitting submission_analyzed event: ${JSON.stringify(result)}`,
    );
